...
export function FilterBar({ value, onChange }: FilterBarProps) {
  return (
    ...
    >
      ...
      >
        <Vegan />
        <div className={'hidden osm1:block'}>Vegan</div>
      </ToggleGroupItem>
      <ToggleGroupItem
        value="vegetarian"
      ...
      >
        <Sprout />
        <div className={'hidden osm1:block'}>Vegetarian</div>
      </ToggleGroupItem>
      <ToggleGroupItem
        value="lactoseFree"
      ...
      >
        <MilkOff />
        <div className={'hidden osm1:block'}>Lactose-free</div>
      </ToggleGroupItem>
      <ToggleGroupItem
        value="glutenFree"
      ...
      >
        <WheatOff />
        <div className={'hidden osm1:block'}>Gluten-free</div>
      </ToggleGroupItem>
    </ToggleGroup>
  );
}
