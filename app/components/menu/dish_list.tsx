...
import { MapPin, MilkOff, NutOff, Sprout, Vegan, WheatOff } from 'lucide-react';
...
export function DishListComponent({
  ...
  const preferOptions: Array<{ value: FilterValue; label: string; icon: ReactNode }> = [
  ...
  const avoidOptions: Array<{ value: FilterValue; label: string; icon: ReactNode }> = [
