...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-sky-500 focus-visible:ring-sky-500/30 focus-visible:ring-[3px] aria-invalid:ring-red-500/20 dark:aria-invalid:ring-red-500/40 aria-invalid:border-red-500 dark:focus-visible:border-sky-400 dark:focus-visible:ring-sky-400/30 dark:aria-invalid:ring-red-900/20 dark:dark:aria-invalid:ring-red-900/40 dark:aria-invalid:border-red-900",
  {
    variants: {
      variant: {
        default:
        ...
        highlight:
          'bg-white shadow-xs hover:bg-zinc-100 hover:text-gray-900 dark:bg-zinc-200/30 dark:text-jcablue dark:hover:bg-zinc-200/50 dark:bg-zinc-950 dark:hover:bg-zinc-800 dark:hover:text-gray-50 dark:dark:bg-zinc-800/30 dark:dark:hover:bg-zinc-800/50',
        secondary:
      ...
      border: {
        outline: 'border border-gray-200 dark:border-zinc-700',
        none: 'border-none',
      },
      rounded: {
        default: 'rounded-0',
