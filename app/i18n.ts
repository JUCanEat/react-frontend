  ...
  en: {
    translation: {
      ...
      profile: {
        ...
        latitudeLabel: `Latitude * (${mapBounds.south} to ${mapBounds.north})`,
        longitudeLabel: `Longitude * (${mapBounds.west} to ${mapBounds.east})`,
        photoUrl: 'Photo URL',
        creating: 'Creating...',
        createRestaurant: 'Create Restaurant',
        updating: 'Updating...',
        updateRestaurant: 'Update Restaurant',
        validationLatitude: `Latitude must be a number between ${mapBounds.south} and ${mapBounds.north}`,
        validationLongitude: `Longitude must be a number between ${mapBounds.west} and ${mapBounds.east}`,
      ...
      manager: {
        ...
        updateRestaurant: 'Update Restaurant',
        validationLatitude: `Latitude must be a number between ${mapBounds.south} and ${mapBounds.north}`,
        validationLongitude: `Longitude must be a number between ${mapBounds.west} to ${mapBounds.east}`,
        failedToCreateRestaurant: 'Failed to create restaurant. Please try again.',
        errorCreatingRestaurant: 'An error occurred while creating the restaurant.',
        failedToUpdateRestaurant: 'Failed to update restaurant. Please try again.',
        errorUpdatingRestaurant: 'An error occurred while updating the restaurant.',
  ...
  pl: {
    translation: {
      ...
      profile: {
        ...
        description: 'Opis',
        latitudeLabel: `Szerokość geogr. * (${mapBounds.south} to ${mapBounds.north})`,
        longitudeLabel: `Długość geogr. * (${mapBounds.west} do ${mapBounds.east})`,
        photoUrl: 'URL zdjęcia',
        creating: 'Tworzenie...',
        createRestaurant: 'Utwórz restaurację',
        updating: 'Aktualizowanie...',
        updateRestaurant: 'Zaktualizuj restaurację',
        validationLatitude: `Szerokość geograficzna musi być liczbą od ${mapBounds.south} do ${mapBounds.north}`,
        validationLongitude: `Długość geograficzna musi być liczbą od ${mapBounds.west} do ${mapBounds.east}`,
      ...
      manager: {
        ...
        restaurantNameRequired: 'Nazwa restauracji *',
        description: 'Opis',
        latitudeLabel: `Szerokość geogr. * (${mapBounds.south} do ${mapBounds.north})`,
        longitudeLabel: `Długość geogr. * (${mapBounds.west} do ${mapBounds.east})`,
        photoUrl: 'URL zdjęcia',
        creating: 'Tworzenie...',
        createRestaurant: 'Utwórz restaurację',
